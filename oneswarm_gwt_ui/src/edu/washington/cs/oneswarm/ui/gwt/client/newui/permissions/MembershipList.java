...
public class MembershipList<T> extends SimplePanel {
    ...
    public MembershipList(String inColumnName, boolean inAdd, List<T> inObjects,
            List<T> inExcluded, boolean useFilter) {
    ...
    public MembershipList(String inColumnName, boolean inAdd, List<T> inObjects,
            List<T> inExcluded, boolean useFilter, Comparator<T> comp) {
        this.setWidth("100%");
    ...
    private void addRow(final T inObject) {
        ...
        Hyperlink addButton = mAdding ? new Hyperlink("(Add)", "Add") : new Hyperlink("(Remove)",
                "Remove");
