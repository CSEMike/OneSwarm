...
public class Strings {
    ...
    public static final String[] SWARM_BUTTON_ACTIONS = new String[] { ADD_SWARM_URL,
            SWARM_BROWSER_PLAY, SWARM_DELETE };
    public static final String[] SWARM_MORE_ACTIONS_SELECTED = new String[] { SWARM_STARTSTOP,
            SWARM_DETAILS, SWARM_DEFAULT_PLAY, SWARM_COPY_MAGNET, SWARM_PUBLISH, SWARM_REVEAL };
    public static final String[] SWARM_MORE_ACTIONS_NOSELECTION = new String[] { ADD_SWARM_FILE,
            MANAGE_PERMS };
    ...
    public static final String[] F2F_RESULTS_COLS = new String[] { F2F_RESULTS_NAME,
            F2F_RESULTS_SIZE, F2F_RESULTS_COLLECTION, F2F_RESULTS_SOURCES /*
                                                                           * ,
                                                                           * F2F_RESULTS_DELAY
                                                                           * ,
                                                                           * /*
    ...
    public static final String[] TRANSFER_DETAILS_COLUMNS = new String[] { XFER_NAME, XFER_SEEDS,
            XFER_PEERS, XFER_PROGRESS, XFER_SIZE, XFER_UPLOAD_RATE, XFER_DOWNLOAD_RATE,
            XFER_REMAINING };
    ...
    public static final String[] TRANSFER_F2F_DETAILS_COLUMNS = new String[] { XFER_NAME,
            XFER_F2F_SEEDS, XFER_F2F_PEERS, XFER_PROGRESS, XFER_SIZE, XFER_UPLOAD_RATE,
            XFER_DOWNLOAD_RATE, XFER_REMAINING };
    ...
    public static final String[] F2F_DETAILS_COLUMNS = new String[] { F2F_XFER_CHANNEL_ID,
            F2F_XFER_CONTENT, F2F_XFER_FROM, F2F_XFER_TO, F2F_XFER_RATE, F2F_XFER_TOTAL };
