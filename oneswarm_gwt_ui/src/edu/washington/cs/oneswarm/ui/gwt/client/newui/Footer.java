...
public class Footer extends HorizontalPanel
{
	...
	public Footer()
	{
		...
		OneSwarmRPCClient.getService().getVersion(
	...
	{
		versionLabel.setHTML("<center><small><a href=\"http://oneswarm.cs.washington.edu/\">OneSwarm</a>: " + mVersionString +
				" | <a href=\"http://forum.oneswarm.org/\">" + msg.footer_forum() + "</a>" +
				" | <a href=\"http://wiki.oneswarm.org/\"><b>" + msg.footer_help() + "</b></a></small></center>");
	}
}
