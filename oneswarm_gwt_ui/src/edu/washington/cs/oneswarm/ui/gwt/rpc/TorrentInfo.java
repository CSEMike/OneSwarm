...
public class TorrentInfo implements IsSerializable {
	...
	public boolean isF2FOnly() { return mFileListLiteRep != null; }
	...
	public int getF2F_ID() { return friendID; }
	public String getF2F_nick() { return friendNick; }
	...
	public boolean isStarted() {
		...
		return status == ST_PREPARING || status == ST_READY || status == ST_DOWNLOADING || status == ST_SEEDING;
	}
