        ...
        if (comparable) {
            Arrays.sort(perm, new Comparator<Integer>() {
                public int compare(Integer o1, Integer o2) {
                    /**
                     * Typecheck so we can use labels to indicate completion
                     * instead of 100% progress bars.
                     */
            ...
            Arrays.sort(perm, new Comparator<Integer>() {
                public int compare(Integer o1, Integer o2) {
                    return entries.get(o1).getElement().getInnerText()
                            .compareTo(entries.get(o2).getElement().getInnerText());
                }
            });
        }
