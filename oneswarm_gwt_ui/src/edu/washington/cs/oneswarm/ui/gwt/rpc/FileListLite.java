...
public class FileListLite implements IsSerializable, Serializable {
    ...
    public FileListLite(String collentionId, String collectionName, String fileName, long fileSize,
            long totalFiles, long addedTime, int inTotalGroupsInList, boolean skipped,
            boolean finishedDL) {
        this.collentionId = collentionId;
        this.collectionName = collectionName;
        this.fileName = fileName;
