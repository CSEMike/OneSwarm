			...
			while (numFilesCreated < fileNum) {
				...
				for (int i = 0; i < numAlbums; i++) {
					...
					for (int j = 0; j < numSongs; j++) {
						...
						BufferedOutputStream out = new BufferedOutputStream(new FileOutputStream(song));
						System.out.print("creating file " + numFilesCreated + "/" + fileNum + ":\t" + song.getAbsolutePath() + "\t");
						...
						System.out.println("wrote " + total / 1024 + " Kb in " + t + "ms (" + (total / (1000 * t)) + " MB/s)");
					}
				}
			}
		} catch (IOException e) {
