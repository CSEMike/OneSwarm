...
public class FileUtil {
  ...
  public static File getApplicationFile(String filename) {
    ...
    String path = SystemProperties.getApplicationPath();
       ...
       * 
       * don't know why they are treating osx differently, the app path 
       * is correct before they add things...
       */
      // if(Constants.isOSX) {
 ...
 public static String
  	...
  	String	file_name_in )
  {
	...
	try{
		...
		// *********************************************************
		// edit, by isdal
		// getCanonicalFile will touch the disk, a very expensive way to remove spaces....
		//if ( Constants.isWindows ){
		if ( true ){
		// *********************************************************
