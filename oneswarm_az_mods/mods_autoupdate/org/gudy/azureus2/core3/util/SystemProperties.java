...
public class SystemProperties {
   ...
   * 
   * some name edits
   * added function to locate the OneSwarm meta info dir
   */
  
  public static String APPLICATION_NAME 		="OneSwarm";   	//= "Azureus";
  private static 		String APPLICATION_ID 	="os"; 			//= "az";
  
  public static String getMetaInfoPath(){
	  File metaInfoDir = new File(getUserPath() + SEP + "metainfo" + SEP);
	  metaInfoDir.mkdirs();
	  try {
		return metaInfoDir.getCanonicalPath();
	} catch (IOException e) {
		e.printStackTrace();
	}
	return null;
  ...
  //************************************************
	/*
	 * EDIT, by isdal
	 * added funtion to locate our mods jar
	 * 
	 * + changes the locateAzureusJar funtion
	 */
	public static String getOneSwarmModsJar() {
		String str = getApplicationPath();
		str += "OneSwarmAzMods.jar";
		return str;
	}
	public static String getAzureusJarPath() {
		String str = getLibPath();
		//	  if( Constants.isOSX ){
		//
	...
	public static String getSwtJar() {
		String str = getLibPath();
		if (Constants.isOSX) {
			str += "swt-osx.jar";
	...
	public static String getLibPath() {
		return getApplicationPath() + "lib" + SEP;
	}
