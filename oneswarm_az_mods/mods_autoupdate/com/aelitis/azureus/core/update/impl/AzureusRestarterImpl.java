...
{    
	...
	/*
	 * Edit: by isdal
	 * changed the update executable name so it uses our exe
	 */
	//private static final String EXE_UPDATER		= "AzureusUpdater.exe";
	private static final String EXE_UPDATER		= "OneSwarmUpdater.exe";
	// ******************************************************************
		...
		boolean	update_only )
	{
		...
		/**
		 * MOD -- to supress the URL open on restart.
		 */
		COConfigurationManager.setParameter("OneSwarm restarting", true);
    ...
    String[] parameters) 
  {
     ...
     System.out.println("restart: " + exec);
  }
