  ...
  public static void init() {
    try {
      ...
      */
      ...
      MessageManager.getSingleton().registerMessageType( new CertificateExchange( null, null, (PublicKey[])null, MESSAGE_VERSION_SUPPORTS_PADDING ));
      MessageManager.getSingleton().registerMessageType( new ReceiptRequests( null, MESSAGE_VERSION_SUPPORTS_PADDING ));
      MessageManager.getSingleton().registerMessageType( new ReceiptBundle( null, (int[])null, MESSAGE_VERSION_SUPPORTS_PADDING ));
      MessageManager.getSingleton().registerMessageType( new Attestation( (Receipt)null, MESSAGE_VERSION_SUPPORTS_PADDING ));
