...
DownloadStats 
{
	...
	/**
	 * Returns the number of continous bytes written to disk, 
	 * starting at byte 0 in piece firstPieceNumber, ending at 
	 * the last byte in piece (firstPieceNumber + numPiecesInFile)
	 * 
	 * @param firstPieceNumber
	 * 	the first piece number to start counting from
	 * @ param numPiecesInFile
	 *  the number of pieces in the file
	 *  
	 *  @return the number of continous bytes 
	 */
	//	public long getContinousFinishedBytes(int firstPieceNumber,
	//			int numPiecesInFile);
