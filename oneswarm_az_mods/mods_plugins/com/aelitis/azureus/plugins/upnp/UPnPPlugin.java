	...
	implements Plugin, UPnPListener, UPnPMappingListener, UPnPWANConnectionListener
{
		...
		PluginInterface	_plugin_interface )
	{
		...
		/**
		 * ONESWARM PIAMOD -- enabled by default
		 */
		natpmp_enable_param = 
			natpmp_config.addBooleanParameter2( "natpmp.enable", "natpmp.enable", true );
		...
		/**
		 * ONESWARM PIAMOD -- changed defaults here. 
		 */
		alert_success_param = upnp_config.addBooleanParameter2( "upnp.alertsuccess", "upnp.alertsuccess", false );
		
		// flipped
		alert_other_port_param = upnp_config.addBooleanParameter2( "upnp.alertothermappings", "upnp.alertothermappings", false );
		
		// flipped
		alert_device_probs_param = upnp_config.addBooleanParameter2( "upnp.alertdeviceproblems", "upnp.alertdeviceproblems", false );
