...
public class UIConfigDefaultsSWT
{
	...
	public static void initialize() {
		...
		def.addParameter("NameColumn.showProgramIcon", !Constants.isWindowsVistaOrHigher);
		...
		//def.addParameter("Start Minimized", true);
		//****************************************************
