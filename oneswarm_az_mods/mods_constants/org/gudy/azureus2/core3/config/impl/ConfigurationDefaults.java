...
//    def.put("oneswarm.v06.firstrun", TRUE);
    ...
    def.put( "Prioritize First Piece", TRUE ); // PIAMOD -- this needs to be true for streaming DL
	...
	def.put( "Tracker Client Send OS and Java Version", FALSE); // PIAMOD -- um, no!
...
//    def.put( "File.Decoder.Default", "" );
    ...
    def.put( "add_torrents_silently", TRUE ); // PIAMOD -- so we don't keep reopening the web UI over and over
