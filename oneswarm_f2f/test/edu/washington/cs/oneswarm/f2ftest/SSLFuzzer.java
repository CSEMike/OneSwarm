...
public class SSLFuzzer {
	...
	public static final byte[] SSL_HANDSHAKE_BYTES = new byte[] { 0, 0, msg_type, major_version, minor_version, cipher_spec_length[0], cipher_spec_length[1], session_id_length[0], session_id_length[1], challenge_length[0], challenge_length[1] };
