...
public class OSF2FXMLBeanReader<T> implements Runnable {
	...
	public OSF2FXMLBeanReader(ClassLoader classloader, Class<T> c, String filename, Semaphore lock, OSF2FXMLBeanReaderCallback<T> callback) {
		this.lock = lock;
		this.cb = callback;
		this.cl = classloader;
		this.c = c;
	...
	private T[] readFriendsFromFile(File friendsFile) throws FileNotFoundException {
		XMLDecoder decoder = new XMLDecoder(new BufferedInputStream(new FileInputStream(friendsFile)), this, new ExceptionListener() {
